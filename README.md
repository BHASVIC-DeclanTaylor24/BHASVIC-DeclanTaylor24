...
In this repository it shows the coursework that i had to do for my A level Computer Science. In doing my coursework it has taught me how i can use many things that i have learnt and connect them all together to create on program. It has also helped me to be able to explain code and what i am doing in greater detail. It has also shown me why every stage is important and why planning things out first is a good habbit to do as well as also testing code so that i can fix and improve stuff as i go along. Also it has helped me understand why it is good to use shareholders and get there feedback so i can tailor it more to them. It finally has taught me that by saving and making checkpoints of where you are can really help you and others for when having to look back at it in the future.
